...
def expandNeighbors(currentState):
    ...
    if (stateOfA == 'A'):
        ...
        if(PPosition == 'UP' and upNeighborOfP != '#' and upNeighborOfP != 'P'
                and ((upNeighborOfP.isdigit() and int(upNeighborOfP) == 0) or (not upNeighborOfP.isdigit()))):
            newState = copy.deepcopy(currentState)
            newState[iP][jP] = 'AP'
            newState[iP - 1][jP] = 'P'
            newState[iA][jA] = replaceA
        ...
        if(PPosition == 'DOWN' and downNeighborOfP != '#' and downNeighborOfP != 'P' 
                and ((downNeighborOfP.isdigit() and int(downNeighborOfP) == 0) or (not downNeighborOfP.isdigit()))):
            newState = copy.deepcopy(currentState)
            newState[iP][jP] = 'AP'
            newState[iP + 1][jP] = 'P'
            newState[iA][jA] = replaceA
        ...
        if(PPosition == 'RIGHT' and rightNeighborOfP != '#' and rightNeighborOfP != 'P'
               and ((rightNeighborOfP.isdigit() and int(rightNeighborOfP) == 0) or (not rightNeighborOfP.isdigit())) ):
            newState = copy.deepcopy(currentState)
            newState[iP][jP] = 'AP'
            newState[iP][jP + 1] = 'P'
            newState[iA][jA] = replaceA
        ...
        if(PPosition == 'LEFT' and leftNeighborOfP != '#' and leftNeighborOfP != 'P'
                and ((leftNeighborOfP.isdigit() and int(leftNeighborOfP) == 0) or (not leftNeighborOfP.isdigit()))):
            newState = copy.deepcopy(currentState)
            newState[iP][jP] = 'AP'
            newState[iP][jP - 1] = 'P'
            newState[iA][jA] = replaceA
